module.exports = {
  ...
  langs: {
    en: {
      current: "╭━━━〔 𝚂𝙷𝙸𝚂𝙷𝙸𝚁-𝐁𝐎𝐓-𝐕5 〕━━━⦿\n┃\n┃ 👑 𝗢𝘄𝗻𝗲𝗿: 𝑨𝒉𝒎𝒆𝑫’𝒔 𝑺𝒉𝒊'𝒔𝒉𝒊𝒓\n┃ 🔗 𝗥𝗲𝗽𝗼: %1\n┃ 💎 𝗦𝘁𝗮𝘁𝘂𝘀: always updating\n┃\n┃ ❝ 𝖳𝗁𝖾 𝖦𝗋𝖾𝖺𝗍𝖾𝗌𝗍 𝖮𝖿 𝖠𝗅𝗅 𝖳𝗂𝗆𝖾 𝖠𝗎𝗍𝗈𝗆𝖺𝗍𝗂𝗈𝗇 ❞\n┃\n╰━━━━━━〔 📥 〕━━━━━━⦿"
    }
  },

  onStart: async function ({ message, getLang }) {
    const link = "আমার শিশির বস এর প্যান্টের নিচে ফর্ক আছে। যদি লাগে তাহলে শিশির বসের টুনটুনি থাকা টু টাকা কইলাম না। হক পেয়ে যাবা 😂";
