    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("sara") || body.startsWith("mikasa") || body.startsWith("hinata") || body.startsWith("xadika") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("alya")) {
            ...
            const baseReplies = [
                ...
                "বেবি না ডাইকা গার্লফ্রেন্ড খুজে দে-🙃🫶🏻", "ডাকিস না তারেক জিয়ার সাথে মিটিংয়ে আছি 😒🖐🏻", "বস ডাক বস😾✌🏻", "বেবি ডাকিস না পরে কোলে উঠে অন্য কিছু খেতে মন চাইবে🌚💋""𝗢𝗶𝗶-মামা ডাকিস না প্লিজ 32 তারিখ আমার বিয়ে-🫣💃🏻", "কতদিন হয়ে গেলো🥺বিছানায় মুতি না মিস ইউ নেংটা কাল-🥺🥀", "🍺_𝗘𝗶𝗶 নেও জুস খাও বেবি বলতে বলতে হাঁপাই গেছো না-🤗", "শুনবো না😼তুমি আমাকে প্রেম করাই দাও নি🥺পচা তুমি🥺",
